...
;
; PURPOSE:
;   Code used to produce Supplementary_Figure_4 from the Brewin et al. (In review) paper submitted to JGR-Oceans in 2022
;
; CATEGORY:
;   Data plotting
;
...
;
; OUTPUTS:
;   Supplementary Figure 4 to the paper
;
; MODIFICATION HISTORY:
; Bob Brewin 17/02/2022

pro Supplementary_Figure_4
